...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const video = document.getElementById('videoPlayer');
        ...
        const videoSrc = params ? `https:www.d-tuning.com/api/files-storage/video/get/${params.file}` : "https:www.d-tuning.com/api/files-storage/video/get/249475_tiny_bda646bf.mp4";
...
function getSecondParameterValue(url, parameterKey) {
    if(!url){ return; }
   // alert(url)
...
//const defaultVideoPath = `${domain}/api/files-storage/video/get/249475_tiny_b01f14ab.mp4`;
    ...
    if (paramValue === null || paramValue === 'null' || paramValue === undefined || paramValue === 'undefined') {
        ...
        videoUrl = paramValue ? `${domain}/api/files-storage/video/get/${paramValue}` : defaultVideoPath;
    }
